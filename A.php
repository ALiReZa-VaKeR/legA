...
function _Header() {
	...
	echo "<html><head><meta http-equiv='Content-Type' content='text/html; charset=" . $_POST['charset'] . "'><title>" . $_SERVER['HTTP_HOST'] . " -LegioNLeakeR WSO " . VERSION ."</title>
<style>
...
<input type=hidden name=charset>
	...
	/* (С) 08.2015 dmkcv */
    echo "<h1 style='color:#2e6e9c !important;font-weight:bolder !important;text-align:center;'>LegioNLeakeR</h1>";
